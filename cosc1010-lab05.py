...
# Lab 05 
# Lab Section: 12
# Sources, people worked with, help given to: Peter Martinez and Chauncy Hendon, Taylor Gili
# your
# comments
# here
...
positiveCounter,negativeCounter,zeroCounter = 0,0,0
...
print(f"Zero occurred {zeroCounter} time(s)")
